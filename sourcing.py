...
def scrape_reports():
    ...
    while True:
        ...
        for report_link in tqdm(en_report_links, desc=f'Page {base_page_num}'):
            ...
            en_download_link = en_content.find('a', class_='btn btn-primary mr-1 mt-2')['href']
            ...
            de_download_link = BeautifulSoup(requests.get(de_report_link).content, 'html.parser')
            de_download_link = de_download_link.find('a', class_='btn btn-primary mr-1 mt-2')['href']
